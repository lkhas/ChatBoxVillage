...
def main():
    ...
    # Page header
    st.markdown('<div class="main-header"><h1>🤖 HR Policy Chatbot</h1><p>Upload your HR documents and ask questions!</p></div>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        uploaded_files = st.file_uploader(
            ...
            help="Upload PDF, TXT, CSV, or DOCX files containing HR policies"
        )
        ...
        if st.session_state.get("openai_api_key"):
            st.markdown('<p class="status-success">✅ API Key: Ready</p>', unsafe_allow_html=True)
        else:
    ...
    if not st.session_state.get("openai_api_key"):
        ...
        <div class="upload-section">
            ...
            <p>2. Upload your HR policy documents</p>
            <p>3. Click "Process Documents" to build the knowledge base</p>
            <p>4. Start asking questions about your HR policies!</p>
        </div>
        """, unsafe_allow_html=True)
        return
    ...
    if not st.session_state.vector_store_ready:
        ...
        <div class="upload-section">
            ...
            <p>Please upload your HR policy documents in the sidebar to get started.</p>
    ...
    # Footer
    st.markdown("---")
    st.markdown("**Note**: This chatbot uses OpenAI's GPT-4 model. Upload your HR policy documents first to create a knowledge base for accurate responses.")
...
def export_conversation_to_txt():
    ...
    export_content = []
    export_content.append("HR Policy Chatbot - Conversation Export")
...
def export_conversation_to_json():
    ...
    export_data = {
        "export_info": {
            ...
            "chatbot_version": "HR Policy Chatbot v2.0"
        },
